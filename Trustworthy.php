...
$male_query = "SELECT FullName FROM details  WHERE Gender = 'Male' AND StudentSection = '12 - Trustworthy'" ;
$male_result = $mysqli->query($male_query);


$female_query = "SELECT FullName FROM details WHERE Gender = 'Female' AND StudentSection = '12 - Trustworthy'";
...
<div class="main">
    <div class="invoice-box" style="width: 750px; right: 150px;">
        <center>
            <h1 style="font-family: Verdana; font-size: 15px">Trustworthy<br>Recorded Students</h1>
        </center>
        <div>
