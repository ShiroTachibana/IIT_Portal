...
$male_query = "SELECT FullName FROM details  WHERE Gender = 'Male' AND StudentSection = '11 - Integrity'" ;
$male_result = $mysqli->query($male_query);


$female_query = "SELECT FullName FROM details WHERE Gender = 'Female' AND StudentSection = '11 - Integrity'";
...
<div class="main">
    <div class="invoice-box" style="width: 750px; right: 150px;">
        <center>
            <h1 style="font-family: Verdana; font-size: 15px">Integrity<br>Recorded Students</h1>
        </center>
        <div>
