...
$male_query = "SELECT FullName FROM details  WHERE Gender = 'Male' AND StudentSection = '11 - Innovative'" ;
$male_result = $mysqli->query($male_query);


$female_query = "SELECT FullName FROM details WHERE Gender = 'Female' AND StudentSection = '11 - Innovative'";
...
<div class="main">
    <div class="invoice-box" style="width: 750px; right: 150px;">
        <center>
            <h1 style="font-family: Verdana; font-size: 15px">Innovative<br>Recorded Students</h1>
        </center>
        <div>
